            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <CardContent className="p-10 space-y-10 text-zinc-400">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-10 border-t border-white/5">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-green-500 font-bold text-sm font-mono">${project.final_price}</p>
                                </div>
                                <div className="space-y-1">
                ...
                <div className="space-y-8">
                    {project.deliverable_url && (
                        <Card className="glass-card border-green-500/20 bg-green-500/5 rounded-[2.5rem] overflow-hidden relative group">
                            ...
                            <CardContent className="p-8 space-y-6 text-center">
                                <div className="h-16 w-16 rounded-[1.5rem] bg-green-500/20 flex items-center justify-center text-green-500 mx-auto border border-green-500/20 shadow-glow-emerald">
                                ...
                                <Button asChild className="w-full h-14 rounded-2xl bg-green-500 text-black font-black hover:scale-105 transition-all uppercase tracking-widest text-[10px]">
